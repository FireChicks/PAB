...
public class ImgLinkCrawlingService {
    private Document doc;
    private Elements elements;

    private String url;
    private String imgLink;
    public ImgLinkCrawlingService(String url) {
        this.url = url;
    }

    public String getInfoFromWebPage() throws IOException {
        ...
        try {
            ...
            imgLink = colorImages.getAttribute("src");
