...
public class MbInfoCrawlingService {
    private Document doc;
    private Elements elements;

    private String url;
    public MbInfoCrawlingService(String url) {
        this.url = url;
    }
    ...
    public ArrayList<String> getInfoFromWebPage() throws IOException {
        ...
        try {
            ...
            elements = driver.findElements(By.xpath("//div[@class='a-section a-spacing-small a-spacing-top-small']//table[@class='a-normal a-spacing-micro']//tbody//td[@class='a-span9']//span[@class='a-size-base po-break-word']"));
